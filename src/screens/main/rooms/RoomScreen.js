import { addMessage, loadMessages } from "lib/actions/rooms"
    ...
    handleAddMessage = () => {
        if (this.state.input)
            this.setState(
                ...
                () => {
                    this.props
                        .addMessage(this.props.roomId, this.state.input)
                        .then(() =>
                            this.setState(prev => ({
                                ...prev,
                                sendLoading: false,
...
const mapStateToProps = ({ rooms, user: { userId } }, { navigation }) => {
